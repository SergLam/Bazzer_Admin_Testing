...
public class SeniorManagerAddEvent {
...
//        }
    ...
    private void addAction(String mng_log, String file_name) {
        ...
        for (WebElement element : inputs) {
            ...
            if (name.equals("date_event")) {
                element.sendKeys(start_date);
            }
            if (name.equals("title")) {
                element.sendKeys("Событие от " + mng_log + " " + String.valueOf(num));
            }
            if (name.equals("file")) {
        ...
        for (WebElement element : textareas) {
            ...
            if (name.equals("description")) {
                element.sendKeys("Описание события от " + mng_log + " " + String.valueOf(num));
            }
        }
